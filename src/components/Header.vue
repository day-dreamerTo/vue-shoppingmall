  ...
  <header class="header">
    ...
    <div class="navbar">
      ...
      <div class="navbar-right-container" style="display: flex;">
        <div class="navbar-menu-container" style="padding-top: 15px;">
          <!--<a href="/" class="navbar-link">我的账户</a>-->
          <span class="navbar-link"></span>
          <a href="javascript:void(0)" class="navbar-link" style="display:inline-block;vertical-align: middle">Login</a>
          <a href="javascript:void(0)" class="navbar-link" style="display:inline-block;vertical-align: middle">Logout</a>
          <div class="navbar-cart-container" style="display:inline-block;vertical-align: middle">
