  ...
  <header class="header">
    ...
    <div class="nav-bar">
      ...
      <div class="nav-cart">
        ...
        <a href="javascript:void(0)" @click="loginModalVisible=true" v-if="!nickName">Login</a>
        <a href="javascript:void(0)" v-if="nickName" @click="logout">Logout</a>
        <a href="javascript:;">
    ...
    <!--// 模态框-->
    <div class="md-modal modal-msg md-modal-transition" :class="{'md-show':loginModalVisible}">
      <div class="md-modal-inner">
        <div class="md-top">
          <div class="md-title">Login in</div>
          <button class="md-close" @click="loginModalVisible=false">Close</button>
        </div>
    ...
    <div class="md-overlay" v-if="loginModalVisible" @click="loginModalVisible=false"></div>
  </header>
</template>
